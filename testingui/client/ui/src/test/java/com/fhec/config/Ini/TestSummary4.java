...
public class TestSummary4 extends JFrame implements ActionListener, Runnable {
	...
	private void initComponents() {// 构造面板
		...
		model = new DefaultTableModel(
				new Object[][] { { "原始列", "原始列", "原始列" }, { "原始列", "原始列", "原始列" }, { "原始列", "原始列", "原始列" } },
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (object == bt1) { // 最加到第一行
			...
			if (table.getSelectedRow() != -1) {
				model.insertRow(table.getSelectedRow(), new Object[] { "追加列_0_0_0", "追加列_0_0_0", "追加列_0_0_0" });
	...
	public void run() {
		...
		while (true) {
			model.insertRow(model.getRowCount(), new Object[] { "追加列_0_0", "追加列_0_0", "追加列_0_0" });
