...
public class CSVUtils {
	...
	public void CSVOutPut() throws IOException {
		if("MES".equals(GlobalContext.UImode)) {
			...
			String Operator_ID = InformationConfirmationView.jLabelMap.get("Operator_ID")==null?"":
								 InformationConfirmationView.jLabelMap.get("Operator_ID").getText();
			...
			String Test_Code = InformationConfirmationView.jLabelMap.get("Test_Code")==null?"": 
				InformationConfirmationView.jLabelMap.get("Test_Code").getText();
			String Test_BinNo = InformationConfirmationView.jLabelMap.get("Test_BinNo")==null?"":
				InformationConfirmationView.jLabelMap.get("Test_BinNo").getText();
			...
			String path = Temporary.local_csvdir_folderpath+ File.separator + LocalConfig.datalog_name_rules + ".csv";
//			String path = "C:\\Users\\jacob\\Desktop\\1" + ".csv";
			...
			dataRowListvalue.put("End_Time:", TeradyneEvent.proendtime);
			dataRowList.add("TesterOS_Version:");
			dataRowListvalue.put("TesterOS_Version:", Temporary.testerOS_Version);
			dataRowList.add("Tester_ID:");
			dataRowListvalue.put("Tester_ID:", InformationConfirmationView.jLabelMap.get("Tester_ID")==null?"":
											   InformationConfirmationView.jLabelMap.get("Tester_ID").getText()
					);
			dataRowList.add("Operator_ID:");
			String Operator_ID  = InformationConfirmationView.jLabelMap.get("Operator_ID")==null?"":
							      InformationConfirmationView.jLabelMap.get("Operator_ID").getText();
			dataRowListvalue.put("Operator_ID:", Operator_ID);
			dataRowList.add("Customer_ID:");
			dataRowListvalue.put("Customer_ID:", InformationConfirmationView.jLabelMap.get("Customer_ID")==null?"":
												 InformationConfirmationView.jLabelMap.get("Customer_ID").getText()
					);
			dataRowList.add("Device_Name:");
			dataRowListvalue.put("Device_Name:",InformationConfirmationView.jLabelMap.get("Device_Name")==null?"":
												InformationConfirmationView.jLabelMap.get("Device_Name").getText()
					);
			dataRowList.add("Customer_LotNo:");
			dataRowListvalue.put("Customer_LotNo:", InformationConfirmationView.jLabelMap.get("Customer_LotNo")==null?"":
													InformationConfirmationView.jLabelMap.get("Customer_LotNo").getText()
					);
			dataRowList.add("Sub_LotNo:");
			dataRowListvalue.put("Sub_LotNo:", InformationConfirmationView.jLabelMap.get("Sub_LotNo")==null?"":
											   InformationConfirmationView.jLabelMap.get("Sub_LotNo").getText()
					);
			dataRowList.add("Program_Name:");
			dataRowListvalue.put("Program_Name:", InformationConfirmationView.jLabelMap.get("Program_Name")==null?"":
												  InformationConfirmationView.jLabelMap.get("Program_Name").getText()
					);
			dataRowList.add("Mode_Code:");
			dataRowListvalue.put("Mode_Code:", InformationConfirmationView.jLabelMap.get("Mode_Code")==null?"":
											   InformationConfirmationView.jLabelMap.get("Mode_Code").getText()
					);
			dataRowList.add("Test_Code:");
			String Test_Code = InformationConfirmationView.jLabelMap.get("Test_Code")==null?"":
						       InformationConfirmationView.jLabelMap.get("Test_Code").getText();
