...
public class TeradyneDriverInit {
	public static boolean DriverModel=true;
	...
	public static void setAllHardBinno(String binno) {
//		if(Integer.parseInt(binno)==-1)
//			return;
	...
	public static void setAllsoftbinno(int binno) {
		/*if(binno==-1)
			return;*/
		boolean binsts = false;
		if (null == allsoftbinno) {
	...
	public static void refreshHardBin() {
		if (hardbinsites!=null&&hardbinsites.size() > 0) {
